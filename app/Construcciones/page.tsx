    ...
    <div>
      ...
      <div>
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-white">
          <h1 className="text-4xl md:text-4xl text-center font-bold">Construcciones Civiles y Mantenimiento</h1>
          <p className="mt-4 text-sm md:text-lg text-center">Ofrecemos servicios de construcción y mantenimiento de alta calidad y con los mejores especialistas.</p>
        </div>
      </div>
